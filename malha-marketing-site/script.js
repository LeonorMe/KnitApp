...
const copy = {
  ...
  "pt-PT": {
    ...
    text: {
      ...
      ".nav-cta": "Testar cedo",
      ".hero .eyebrow": "Um sistema calmo para criar com as mãos",
      "#hero-title": "Transforma planos soltos em projetos terminados.",
      ".hero-copy":
        "A app calma para terminar projetos de tricô e crochet. Planeia o trabalho, acompanha cada carreira, usa o que tens e volta a cada ponto com confianca.",
      ...
      ".aidi-note p": "Aidi encontrou lã verde guardada suficiente para terminar a manga.",
      ".intro-band p":
        "Criada em torno de um principio simples: recompensar a criação, não o consumo. A Malha mantem a alegria do artesanato enquanto ajuda a terminar mais, comprar melhor e sentir orgulho nos projetos que já tens em mão.",
      ".problem-section .eyebrow": "O problema",
      "#problem-title": "Demasiados modelos, demasiado fio, muitos... projetos por acabar?",
      ...
      ".problem-grid article:nth-child(2) span:last-child":
        "Os materiais esquecem-se facilmente quando o stock não aparece durante o planeamento.",
      ".problem-grid article:nth-child(3) strong": "Amanhã continuo...",
      ".problem-grid article:nth-child(3) span:last-child":
        "Os projetos tornam-se mais dificeis de retomar quando o proximo passo não é claro.",
      ...
      ".audience-grid article:nth-child(1) p":
        "Passos simples, instrucões mais claras e futuras explicações da Aidi quando uma técnica parecer confusa.",
      ".audience-grid article:nth-child(2) h3": "Artesãos intermédios",
      ".audience-grid article:nth-child(2) p":
        "Estado do projeto, materiais, notas e variantes organizadas quando o trabalho fica mais ambicioso.",
      ...
      ".screenshots-section .eyebrow": "Ecrãs conceito",
      "#screens-title": "Uma antevisão dos fluxos que a Malha vai ligar.",
      ...
      ".feature-grid article:nth-child(3) h3": "Fluxo sem mãos",
      ".feature-grid article:nth-child(3) p":
      ...
      ".feature-grid article:nth-child(4) p":
        "A partilha futura de modelos vai dar prioridade a conclusoes verificadas, variantes, correcoes e resultados reais.",
      "#aidi .eyebrow": "Conhece a Aidi",
      "#aidi-title": "Assistencia por IA que se mantém calma e útil.",
      "#aidi > div:first-child p:nth-of-type(2)":
        "Aidi é a futura companheira de IA da Malha. Vai explicar passos, sugerir projetos a partir do stock, estimar fio e adaptar modelos com níveis de confianca claros.",
      "#aidi > div:first-child p:nth-of-type(3)":
        "A IA e tratada como assistente, não como autoridade. O fluxo principal continua fiavel offline, enquanto que a inteligência avancada suporta o planeamento, aprendizagem e descoberta.",
      ".brand-note":
        'Em português, "perdi o fio a meada" significa perder o rumo da historia. A Malha foi criada para ajudar a manter esse fio.',
      "#aidiQuote": "Já tens fios que combinam com este projeto. Queres planear a partir do teu stock?",
      ".benefits-section .eyebrow": "Porque é que as pessoas voltam",
      "#benefits-title": "Uma forma mais calma de tornar o progresso visível.",
      ".benefit-list > div:nth-child(1) strong": "Concluir mais",
      ...
      "#future .eyebrow": "Ligação para a app em breve",
      ...
      ".roadmap > div:nth-child(1) span:last-child": "Projetos, modelos, materiais, progresso offline.",
      ".roadmap > div:nth-child(2) .status": "Futuro",
      ".roadmap > div:nth-child(2) strong": "inteligência",
      ".roadmap > div:nth-child(2) span:last-child": "Recomendações da Aidi, estimativa de fio, ajuda com modelos.",
      ".roadmap > div:nth-child(3) .status": "Futuro",
      ".roadmap > div:nth-child(3) strong": "Economia",
      ".roadmap > div:nth-child(3) span:last-child": "Recompensas suaves por consistência, conclusao e uso do stock.",
      ".roadmap > div:nth-child(4) .status": "Futuro",
      ".roadmap > div:nth-child(4) strong": "Ecossistema",
      ".roadmap > div:nth-child(4) span:last-child": "Validação comunitária, variantes de modelos, marketplace.",
      ...
      ".trust-grid article:nth-child(1) p":
        "A execucao do projeto deve funcionar mesmo sem internet, porque criar é real.",
      ".trust-grid article:nth-child(2) h3": "IA identificada",
      ".trust-grid article:nth-child(2) p":
        "As sugestoes da Aidi serão claramente marcadas, editáveis e acompanhadas por sinais de confiança.",
      ".trust-grid article:nth-child(3) h3": "Controlo dos dados",
      ".trust-grid article:nth-child(3) p":
        "Materiais, histórico de projetos e futuro contexto de IA devem ser compreensíveis e exportáveis.",
      ".vote-section .eyebrow": "Ajuda a moldar a Malha",
      "#vote-title": "Vota no que deve chegar primeiro.",
      ".vote-options button:nth-child(1)": "Tracker de modelos",
      ...
      "#voteMessage": "A votação é provisória por agora.",
      ".faq-section .eyebrow": "FAQ",
      "#faq-title": "Perguntas comuns",
      ".faq-list details:nth-child(1) summary span": "Quando é que app fica disponivel?",
      ".faq-list details:nth-child(1) p":
        "A primeira versão está prevista para junho de 2026. Esta página vai depois ligar à app, screenshots e vídeo demonstrativo.",
      ".faq-list details:nth-child(2) summary span": "Vai ser Android ou iOS?",
      ".faq-list details:nth-child(2) p":
        "A direção técnica atual começa em Android. Outras plataformas podem chegar mais tarde se houver procura.",
      ".faq-list details:nth-child(3) summary span": "A IA vai gerar modelos completos?",
      ".faq-list details:nth-child(3) p":
        "A IA será posicionada como assistente para explicações, estimativas e rascunhos. A validação humana continua a ser necessária.",
      ".faq-list details:nth-child(4) summary span": "A app vai funcionar offline?",
      ".faq-list details:nth-child(4) p":
        "O tracker de projetos, progresso, notas e sistema de materiais estão planeados como funcionalidades offline-first.",
      ".faq-list details:nth-child(5) summary span": "Vai existir uma versão gratuíta?",
      ".faq-list details:nth-child(5) p":
        "A intenção é haver uma base gratuíta útil, com funcionalidades premium com IA e marketplace posteriores.",
      "#waitlist .eyebrow": "Primeiros testes",
      "#waitlist-title": "A Malha ainda esta a ser tecida.",
      "#waitlist > div:first-child > p:not(.eyebrow)":
        "A primeira versão está prevista para junho de 2026. A ligação para a app, capturas de ecrã, vídeo demo e lista de emails serão adicionados aqui quando estiverem prontos.",
      ".contact-links a:nth-child(1)": "Email",
      ".contact-links a:nth-child(2)": "GitHub",
      ".contact-links a:nth-child(3)": "Instagram em breve",
      ".signup-form label": "Email para novidades da app",
      "#notifyButton": "Avisar-me",
      ".site-footer span:nth-child(2)": "Termina mais. Compra melhor. Cria melhor.",
      ".site-footer span:nth-child(3)": "© 2026 Malha. Todos os direitos reservados."
    },
    placeholders: {
      "#email": "tu@exemplo.pt"
    },
